...
public class TagsAdminCommand extends AbstractCommand {
    ...
    private void handleGive(CommandSender sender, String[] args) {
        ...
        tagStore.addOwnedTag(uuid, tagId);
    ...
    private void handleRemove(CommandSender sender, String[] args) {
        ...
        tagStore.removeOwnedTag(uuid, tagId);
    ...
    private UUID resolveUuidOrFail(CommandSender sender, String username) {
        Optional<UUID> uuid = tagStore.resolveUuidByUsername(username);
        if (uuid.isEmpty()) {
